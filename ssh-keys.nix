...
in {
  ...
  hosts = {
    ...
    ultros = {};
    zodiark = {
      ecdsa = "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBMkmpsCGcGo9/LlKyRv3VL2pGa59bqbu/K3o+/eZTtNOhuLxZ1W5SdkQEZGO6G2zLkFwKcH0MoA+ibGs0MA5BTA=";
      ed25519 = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIABjIJ3CGk/eUxUQQG7e8Z3DWErYN27ZYAZkfQvHO6rU";
      rsa = "ssh-rsa ";
    };
  };
}
